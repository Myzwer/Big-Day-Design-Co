            ...
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-12 md:col-span-6">
                    <div class="text-center md:py-5 font-bold uppercase">
                        <img class="shadow-lg rounded-xl" src="<?php the_field('template_image') ?> "
                             alt="Template Images">
                    </div>
                </div>
                <div class="col-span-12 md:col-span-6 md:ml-10 relative">
                    <div class="content-middle-medium">
                        <div class="pb-5 font-bold">
                            <h2 class="text-2xl text-left uppercase pb-3">3 elegant options, with all the features you
                                want
                                and none you don’t.</h2>
            ...
            <div class="mx-4 md:mx-10 lg:max-w-5xl lg:mx-auto py-10">
                <div class="grid grid-cols-12 gap-4 md:gap-10">
                    ...
                    <div class="col-span-12">
                        <div class="grid grid-cols-12 gap-4 md:gap-10">
                            <div class="col-span-12 md:col-span-6">
                                <img class="rounded-lg shadow-lg" src="<?php the_field('template_1') ?>"
                                     alt="Template 1">
                            </div>
                    ...
                    <div class="col-span-12">
                        <div class="grid grid-cols-12 gap-4 md:gap-10">
                            <div class="col-span-12 md:col-span-6">
                                <img class="rounded-lg shadow-lg" src="<?php the_field('template_2') ?>"
                                     alt="Template 1">
                            </div>
                            <div class="col-span-12 md:col-span-6 relative">
                                <div class="content-middle-medium">
                    ...
                    <div class="col-span-12">
                        <div class="grid grid-cols-12 gap-4 md:gap-10">
                            <div class="col-span-12 md:col-span-6">
                                <img class="rounded-lg shadow-lg" src="<?php the_field('template_3') ?>"
                                     alt="Template 1">
                            </div>
                            <div class="col-span-12 md:col-span-6 relative">
                                <div class="content-middle-medium">
