...
get_header(); ?>
    ...
    <div class="bg-no-repeat bg-scroll bg-cover relative" style="background: linear-gradient(
        ...
        <div class="content-middle text-white text-center">
            <h1 class="text-4xl mb-7 px-2">Privacy Policy. Reading this takes longer than my entire process.</h1>
            <h2 class="text-md font-bold uppercase body-font">(For legal reasons, this is a joke)</h2>
        </div>
    </div>
